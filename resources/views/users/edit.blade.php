...
<div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <main class="flex-1 p-4 md:p-8">
        <section class="bg-white rounded-2xl shadow-md p-6 max-w-2xl mx-auto">
            <h2 class="text-lg font-semibold text-gray-800 mb-6">Update User Information</h2>
               ...
               <!-- Role -->
                <div>
                    ...
                    <select name="role"
                        ...
                        <option value="sales_user" {{ $user->role === 'sales_user' ? 'selected' : '' }}>Sales User</option>
